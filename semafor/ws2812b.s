...
.LFE113:
	...
	.align	2
	.global	set_led_range
	.thumb
	.thumb_func
	.type	set_led_range, %function
set_led_range:
.LFB114:
	.loc 2 84 0
	.cfi_startproc
...
.L23:
	...
	.cfi_endproc
.LFE114:
	.size	set_led_range, .-set_led_range
	.align	2
	.global	send_data
	.thumb
	.thumb_func
...
.L29:
	...
	.loc 2 102 0 is_stmt 1 discriminator 4
	ldr	r3, [r7, #8]
	adds	r3, r3, #1
	str	r3, [r7, #8]
	.loc 2 100 0 discriminator 4
	ldr	r3, [r7]
	subs	r3, r3, #1
	str	r3, [r7]
.L27:
	...
	cmp	r3, #0
	bge	.L30
	.loc 2 104 0 is_stmt 1 discriminator 2
	ldr	r3, [r7, #4]
	adds	r3, r3, #4
	str	r3, [r7, #4]
.LBE2:
...
.LASF219:
	.ascii	"src/ws2812b.c\000"
.LASF82:
	.ascii	"OTG_HS_EP1_OUT_IRQn\000"
.LASF221:
	.ascii	"DMA1_Stream7_IRQHandler\000"
.LASF218:
